...
class ViTPatchEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        num_patches = 100#(image_size[1] // patch_size[1]) * (image_size[0] // patch_size[0])
        ...
        self.projection = nn.Linear(40, hidden_size)
...
#             if False:#height != self.image_size[0] or width != self.image_size[1]:
#                 raise ValueError(
